...
export default async function ContactPage() {
  ...
  return (
    <main>
      <PageHero eyebrow="Contact" title="Parlez-nous du trajet que vous préparez" description="Utilisez uniquement les coordonnées officielles publiées ci-dessous. Aucun formulaire ne collecte vos données tant que le système de contact sécurisé n’est pas activé." />
